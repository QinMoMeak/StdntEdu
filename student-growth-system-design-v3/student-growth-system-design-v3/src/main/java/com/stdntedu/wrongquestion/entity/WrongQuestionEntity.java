...
public class WrongQuestionEntity {
 ...
 private String sourceType; private String sourceName; @TableField(updateStrategy=FieldStrategy.ALWAYS) private String questionType; private String questionText;
