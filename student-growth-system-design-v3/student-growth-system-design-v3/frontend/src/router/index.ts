...
const placeholderRoutes: RouteRecordRaw[] = [
  { path: 'dashboard', component: PlaceholderView, meta: { title: '首页' } },
  { path: 'students', component: PlaceholderView, meta: { title: '学生档案' } },
    ...
    routes: [
      {
        ...
        component: AppShell,
        meta: { title: '首页' },
        children: [{ path: '', redirect: '/dashboard' }, ...placeholderRoutes],
      },
    ],
  })
}
